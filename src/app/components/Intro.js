        ...
        <section
            ...
            <div className="flex flex-col justify-center items-center mt-5">
                ...
                <motion.h1
                    ...
                    <span className="font-bold">Hello, I&apos;m Pratik.</span>{" "}
                    I&apos;m a{" "}
                    <span className="font-bold">full-stack developer</span> with{" "}
                    <span className="font-bold">1 years</span> of experience in{" "}
                    <span className="underline">React/Next.js</span>. and{" "}
                    <span className="font-bold">6 months</span> of experience in
                    <span className="underline"> Node/express.</span> I enjoy
